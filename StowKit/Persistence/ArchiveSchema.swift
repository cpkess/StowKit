...
enum ArchiveMigrationPlan: SchemaMigrationPlan {
    static var schemas: [any VersionedSchema.Type] { [ArchiveSchemaV1.self, ArchiveSchemaV2.self, ArchiveSchemaV3.self, ArchiveSchemaV4.self, ArchiveSchemaV5.self, ArchiveSchemaV6.self, ArchiveSchemaV7.self, ArchiveSchemaV8.self] }
