...
8. The sidebar's bottom-left button names the archive in use and switches archives (also **File → Switch Archive**). In an iCloud archive, documents behave like iCloud Drive files: a cloud badge marks ones not on this Mac, **Download Now** fetches them, and **Remove Download** frees the local copy while keeping it in iCloud.
